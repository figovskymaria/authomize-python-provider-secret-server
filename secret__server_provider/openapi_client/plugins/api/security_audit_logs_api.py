...
class SecurityAuditLogsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.security_audit_logs_service_search_logs_endpoint = _Endpoint(
            settings={
                'response_type': (PagingOfSecurityAuditLogSummaryAndSecurityAuditLogFilter,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/v1/security-audit-logs',
                'operation_id': 'security_audit_logs_service_search_logs',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    'filter_is_exporting': 'filter.isExporting',
    ...
    def security_audit_logs_service_search_logs(
        self,
        **kwargs
    ):
        """Search Security Audit Logs  # noqa: E501

        Search, filter, sort, and page security audit logs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.security_audit_logs_service_search_logs(async_req=True)
        >>> result = thread.get()
        ...
        return self.security_audit_logs_service_search_logs_endpoint.call_with_http_info(**kwargs)
