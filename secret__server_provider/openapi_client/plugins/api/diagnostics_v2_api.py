...
class DiagnosticsV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.diagnostics_v2_service_search_system_log_endpoint = _Endpoint(
            settings={
                'response_type': (IPagingOfSystemLogSummaryModel,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/v2/diagnostics/system-logs',
                'operation_id': 'diagnostics_v2_service_search_system_log',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    'filter_log_level': 'filter.logLevel',
    ...
    def diagnostics_v2_service_search_system_log(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.diagnostics_v2_service_search_system_log(async_req=True)
        >>> result = thread.get()
        ...
        return self.diagnostics_v2_service_search_system_log_endpoint.call_with_http_info(**kwargs)
