...
class SdkClientAuditsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.sdk_client_audits_service_search_client_audit_endpoint = _Endpoint(
            settings={
                'response_type': (PagingOfSdkClientAuditSummaryAndSdkClientAuditFilter,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/v1/sdk-client-audits',
                'operation_id': 'sdk_client_audits_service_search_client_audit',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def sdk_client_audits_service_search_client_audit(
        self,
        **kwargs
    ):
        """Search SDK Client Audits  # noqa: E501

        Search, filter, sort, and page app SDK Client audits  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sdk_client_audits_service_search_client_audit(async_req=True)
        >>> result = thread.get()
        ...
        return self.sdk_client_audits_service_search_client_audit_endpoint.call_with_http_info(**kwargs)
