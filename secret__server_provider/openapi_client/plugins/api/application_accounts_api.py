...
class ApplicationAccountsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.application_accounts_service_lookup_account_endpoint = _Endpoint(
            settings={
                'response_type': (PagingOfUserLookup,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/v1/application-accounts/lookup',
                'operation_id': 'application_accounts_service_lookup_account',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    'filter_include_all': 'filter.includeAll',
    ...
    def application_accounts_service_lookup_account(
        self,
        **kwargs
    ):
        """Lookup Application Accounts  # noqa: E501

        Search, filter, sort, and page application accounts, returning only user id and display  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.application_accounts_service_lookup_account(async_req=True)
        >>> result = thread.get()
        ...
        return self.application_accounts_service_lookup_account_endpoint.call_with_http_info(**kwargs)
