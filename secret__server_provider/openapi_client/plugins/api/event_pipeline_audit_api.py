...
class EventPipelineAuditApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.event_pipeline_audit_service_get_all_pipeline_and_policy_audits_endpoint = _Endpoint(
            settings={
                'response_type': (PagingOfEventPipelinePolicyAuditSummary,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/v1/event-pipeline-audit',
                'operation_id': 'event_pipeline_audit_service_get_all_pipeline_and_policy_audits',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def event_pipeline_audit_service_get_all_pipeline_and_policy_audits(
        self,
        **kwargs
    ):
        """Get Pipeline / Policy Audits  # noqa: E501

        Retrieve all of the audits for both pipeline and policy audit entries  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.event_pipeline_audit_service_get_all_pipeline_and_policy_audits(async_req=True)
        >>> result = thread.get()
        ...
        return self.event_pipeline_audit_service_get_all_pipeline_and_policy_audits_endpoint.call_with_http_info(**kwargs)
