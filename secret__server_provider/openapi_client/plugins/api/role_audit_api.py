...
class RoleAuditApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.role_audit_service_get_role_audits_endpoint = _Endpoint(
            settings={
                'response_type': (PagingOfRoleAuditSummary,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/v1/role-audits',
                'operation_id': 'role_audit_service_get_role_audits',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'filter_audit_type': 'filter.auditType',
                    'skip': 'skip',
    ...
    def role_audit_service_get_role_audits(
        self,
        is_exporting,
        **kwargs
    ):
        """Search Role audits  # noqa: E501

        Search, filter, sort, and page Role audits  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.role_audit_service_get_role_audits(is_exporting, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['is_exporting'] = \
            is_exporting
        return self.role_audit_service_get_role_audits_endpoint.call_with_http_info(**kwargs)
