...
class ViewFieldValueOfOptionalBmcChangeManagementCommentWorkType(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ViewFieldValueOfOptionalBmcChangeManagementCommentWorkType - a model defined in OpenAPI
