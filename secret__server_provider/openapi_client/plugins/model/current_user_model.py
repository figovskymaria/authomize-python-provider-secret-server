...
class CurrentUserModel(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CurrentUserModel - a model defined in OpenAPI
