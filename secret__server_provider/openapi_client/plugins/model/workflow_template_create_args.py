...
class WorkflowTemplateCreateArgs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, workflow_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, workflow_type, *args, **kwargs):  # noqa: E501
        """WorkflowTemplateCreateArgs - a model defined in OpenAPI
