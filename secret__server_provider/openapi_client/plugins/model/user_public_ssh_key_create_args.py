...
class UserPublicSshKeyCreateArgs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, format, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, format, *args, **kwargs):  # noqa: E501
        """UserPublicSshKeyCreateArgs - a model defined in OpenAPI
