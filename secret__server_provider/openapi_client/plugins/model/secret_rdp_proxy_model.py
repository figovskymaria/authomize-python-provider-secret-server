...
class SecretRdpProxyModel(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SecretRdpProxyModel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            domain (bool, date, datetime, dict, float, int, list, str, none_type): The domain for the RDP Proxy. [optional]  # noqa: E501
            host (bool, date, datetime, dict, float, int, list, str, none_type): The host and port for the RDP Proxy. [optional]  # noqa: E501
