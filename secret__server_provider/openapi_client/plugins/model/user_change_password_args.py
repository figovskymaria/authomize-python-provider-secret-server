...
class UserChangePasswordArgs(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'current_password': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, current_password, new_password, *args, **kwargs):  # noqa: E501
        """UserChangePasswordArgs - a model defined in OpenAPI
