...
class InternalServerErrorResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, message, exception_message, exception_type, stack_trace, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, message, exception_message, exception_type, stack_trace, *args, **kwargs):  # noqa: E501
        """InternalServerErrorResponse - a model defined in OpenAPI
