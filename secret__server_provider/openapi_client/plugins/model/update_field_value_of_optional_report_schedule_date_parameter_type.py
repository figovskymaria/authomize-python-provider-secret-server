...
class UpdateFieldValueOfOptionalReportScheduleDateParameterType(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateFieldValueOfOptionalReportScheduleDateParameterType - a model defined in OpenAPI
