...
class UpdateFieldValueOfOptionalLauncherConnectAsLineEnding(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateFieldValueOfOptionalLauncherConnectAsLineEnding - a model defined in OpenAPI
