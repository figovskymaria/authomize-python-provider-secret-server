...
class PreferenceModel(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PreferenceModel - a model defined in OpenAPI
