...
class FolderTemplateArgs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, folder_id, template_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, folder_id, template_id, *args, **kwargs):  # noqa: E501
        """FolderTemplateArgs - a model defined in OpenAPI
