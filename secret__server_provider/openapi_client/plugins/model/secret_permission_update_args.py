...
class SecretPermissionUpdateArgs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, secret_access_role_name, secret_id, *args, **kwargs):  # noqa: E501
        ...
        self.id = id
        self.secret_access_role_name = secret_access_role_name
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, secret_access_role_name, secret_id, *args, **kwargs):  # noqa: E501
        """SecretPermissionUpdateArgs - a model defined in OpenAPI
