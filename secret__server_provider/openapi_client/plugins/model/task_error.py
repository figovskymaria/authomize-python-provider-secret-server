...
class TaskError(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TaskError - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            error_message (bool, date, datetime, dict, float, int, list, str, none_type): The error message. [optional]  # noqa: E501
            item_name (bool, date, datetime, dict, float, int, list, str, none_type): The name of the item that had the error. [optional]  # noqa: E501
        """
