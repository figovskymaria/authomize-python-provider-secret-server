...
class EventPipelineTriggerSummary(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EventPipelineTriggerSummary - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            event_action_id (bool, date, datetime, dict, float, int, list, str, none_type): Event Action ID ID. [optional]  # noqa: E501
