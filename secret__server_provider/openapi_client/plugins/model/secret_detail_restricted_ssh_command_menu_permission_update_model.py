...
class SecretDetailRestrictedSshCommandMenuPermissionUpdateModel(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SecretDetailRestrictedSshCommandMenuPermissionUpdateModel - a model defined in OpenAPI
