...
class OnlineActivationArgs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, name, phone_number, *args, **kwargs):  # noqa: E501
        """OnlineActivationArgs - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, name, phone_number, *args, **kwargs):  # noqa: E501
        """OnlineActivationArgs - a model defined in OpenAPI
