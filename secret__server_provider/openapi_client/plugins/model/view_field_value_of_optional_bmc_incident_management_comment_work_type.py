...
class ViewFieldValueOfOptionalBmcIncidentManagementCommentWorkType(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ViewFieldValueOfOptionalBmcIncidentManagementCommentWorkType - a model defined in OpenAPI
