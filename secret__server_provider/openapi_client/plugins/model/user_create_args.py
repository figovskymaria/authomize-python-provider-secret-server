...
class UserCreateArgs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, display_name, password, user_name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, display_name, password, user_name, *args, **kwargs):  # noqa: E501
        """UserCreateArgs - a model defined in OpenAPI
