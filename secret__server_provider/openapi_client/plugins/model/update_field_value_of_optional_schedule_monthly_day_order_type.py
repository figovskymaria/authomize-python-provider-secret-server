...
class UpdateFieldValueOfOptionalScheduleMonthlyDayOrderType(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateFieldValueOfOptionalScheduleMonthlyDayOrderType - a model defined in OpenAPI
