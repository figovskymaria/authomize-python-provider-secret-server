...
class FolderUpdateArgs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, folder_name, folder_type_id, id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, folder_name, folder_type_id, id, *args, **kwargs):  # noqa: E501
        """FolderUpdateArgs - a model defined in OpenAPI
