...
class SshCommandMenuCreateModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, active, description, name, ssh_commands, *args, **kwargs):  # noqa: E501
        """SshCommandMenuCreateModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, active, description, name, ssh_commands, *args, **kwargs):  # noqa: E501
        """SshCommandMenuCreateModel - a model defined in OpenAPI
