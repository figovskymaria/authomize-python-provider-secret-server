...
class AppClientUpdateArgs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, redirect_uri, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, redirect_uri, *args, **kwargs):  # noqa: E501
        """AppClientUpdateArgs - a model defined in OpenAPI
