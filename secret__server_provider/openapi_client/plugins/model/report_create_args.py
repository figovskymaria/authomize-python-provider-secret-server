...
class ReportCreateArgs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, category_id, description, name, report_sql, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, category_id, description, name, report_sql, *args, **kwargs):  # noqa: E501
        """ReportCreateArgs - a model defined in OpenAPI
